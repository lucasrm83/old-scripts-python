...
for contador in range(5,35,5):
    ...
    elif tempoCalculo < 60 * 60 * 24 * 365 * 1000 * 1000 * 1000 * 1000:
      print("Tempo para calculo: ", int(tempoCalculo / ( 60 * 60 * 24 * 365 * 1000 * 1000 * 1000)), " bilhões de anos")
    else:
      print("Tempo para calculo: ", int(tempoCalculo / ( 60 * 60 * 24 * 365 * 1000 * 1000 * 1000 * 1000)), " trilhões de anos")